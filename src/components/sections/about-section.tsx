      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
            <h2 className="font-headline text-4xl font-bold tracking-tight sm:text-5xl">
              {dictionary.about.title_part1} <span className="text-primary">{dictionary.about.title_part2}</span>
            </h2>
        </div>
        <div className="grid gap-16 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3 flex flex-col justify-center">
            <p className="mt-6 text-lg text-muted-foreground">
              {dictionary.about.intro_p1}
            </p>
            <p className="mt-4 text-lg text-muted-foreground">
              {dictionary.about.intro_p2}
            </p>
          </div>
        </div>
        <div className="mt-16">
          <h3 className="mb-8 text-center text-3xl font-bold">{dictionary.about.expertise_title}</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            <div className="rounded-lg bg-card p-6 border border-transparent hover:border-primary transition-colors duration-300">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h4 className="text-xl font-semibold">{dictionary.about.design_tools_title}</h4>
              </div>
             ...
             <div className="rounded-lg bg-card p-6 border border-transparent hover:border-primary transition-colors duration-300">
               <div className="flex items-center gap-4 mb-4">
                ...
                <h4 className="text-xl font-semibold">{dictionary.about.ux_title}</h4>
              </div>
              <div className="flex flex-wrap gap-2">
                {uxSkills.map(skill => (
                   <Badge key={skill} variant="secondary">
            ...
            <div className="rounded-lg bg-card p-6 border border-transparent hover:border-primary transition-colors duration-300">
               <div className="flex items-center gap-4 mb-4">
                ...
                <h4 className="text-xl font-semibold">{dictionary.about.frontend_title}</h4>
              </div>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="rounded-lg bg-card p-6 border border-transparent hover:border-primary transition-colors duration-300">
               <div className="flex items-center gap-4 mb-4">
                ...
                <h4 className="text-xl font-semibold">{dictionary.about.platforms_title}</h4>
              </div>
              <div className="flex flex-wrap gap-2">
             ...
             <div className="rounded-lg bg-card p-6 border border-transparent hover:border-primary transition-colors duration-300">
               <div className="flex items-center gap-4 mb-4">
                ...
                <h4 className="text-xl font-semibold">{dictionary.about.ai_tools_title}</h4>
              </div>
              <div className="flex flex-wrap gap-2">
                {aiSkills.map(skill => (
                   <Badge key={skill} variant="secondary">
