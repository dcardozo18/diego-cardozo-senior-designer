    ...
    <section id="about" className="bg-secondary py-20 md:py-32">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-16 lg:grid-cols-2">
          ...
          <div>
            <div className="relative mx-auto h-64 w-64 lg:h-80 lg:w-80 overflow-hidden rounded-full shadow-2xl mb-8">
              <Image
             ...
             <div className="text-center">
                <h3 className="text-2xl font-bold">Diego Cardozo</h3>
                <p className="text-muted-foreground">Senior Web & UI/UX Designer</p>
            </div>
          </div>
        </div>
        <div className="mt-16">
          <h3 className="mb-8 text-center text-3xl font-bold">Highlights</h3>
